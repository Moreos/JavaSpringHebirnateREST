...
public class PersonalComputer {
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "personalComputer")
    private Set<PersonalComputerModel> personalComputers;

    public PersonalComputer() {}

    public PersonalComputer(String name, String countryOfManufacturer, String firmOfManufacturer, Boolean canOrderOnline, Boolean canInstallments) {
        this.name = name;
    ...
    public Set<PersonalComputerModel> getPersonalComputers() {
        return personalComputers;
    }

    public void setPersonalComputers(Set<PersonalComputerModel> personalComputers) {
